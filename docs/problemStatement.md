...
### 1. Corpus Definition
*   **Initial Scope**: Currently limiting the corpus to **5 specific URLs** (listed below), but the approach and implementation must be **highly scalable** to ingest and query any arbitrary number of URLs in the future:
    *   [HDFC Mid-Cap Opportunities Fund Direct Growth](https://groww.in/mutual-funds/hdfc-mid-cap-fund-direct-growth)
    *   [HDFC Top 100 Fund (Large Cap) Direct Growth](https://groww.in/mutual-funds/hdfc-large-cap-fund-direct-growth)
...
*   **Scalability**: The system should allow easy expansion to broader documents, such as:
    *   Scheme factsheets, KIM, SID, AMC FAQ/help pages, AMFI/SEBI guidance pages, and tax document download guides.
...
*   Answer **facts-only** queries, such as:
    ...
    *   Benchmark index
    *   Fund management data (e.g., fund manager name, experience, active tenure, and other schemes managed)
